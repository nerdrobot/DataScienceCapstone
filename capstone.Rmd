...
```{r}
modelRating <- mapply(dang, dataSet$recentSnow, dataSet$recentWindLoading, dataSet$highTemp, dataSet$criricalLoading, dataSet$criticalWindLoading, dataSet$slabAvalanche, dataSet$psp)
